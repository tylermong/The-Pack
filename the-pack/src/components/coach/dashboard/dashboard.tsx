        ...
        <div className='flex flex-col pb-24'>
            ...
            <div className='grid grid-cols-2 gap-4 items-center justify-center pl-20 pt-6 pr-3'>
                ...
                <Card className='flex flex-col bg-primary border border-solid worder-white items-center'>
                    ...
                    <CardContent>
                        <Button variant='outline' onClick={() => router.push('/coach/fitness-tracker/dashboard/schedule')}> 
                            View Schedule
                        </Button>
                    </CardContent>
                </Card>
                ...
                <Card className='flex flex-col bg-primary border border-solid worder-white items-center'>
                    ...
                    <CardContent>
                        <Button variant='outline' onClick={() => router.push('/coach/fitness-tracker/dashboard/classes')}> 
                            View Classes
                        </Button>
                    </CardContent>
                </Card>
                ...
                <Card className='flex flex-col bg-primary border border-solid worder-white items-center'>
                    ...
                    <CardContent>
                        <Button variant='outline' onClick={() => router.push('/coach/fitness-tracker/dashboard/clients')}> 
                            View Clients
                        </Button>
                    </CardContent>
                </Card>
                ...
                <Card className='flex flex-col bg-primary border border-solid worder-white items-center'>
                    ...
                    <CardContent>
                        <Button variant='outline' onClick={() => router.push('/coach/fitness-tracker/dashboard/appointments')}> 
                            View Appointments
                        </Button>
                    </CardContent>
                </Card>
