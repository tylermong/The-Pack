        ...
        <div className='flex flex-col pb-24'>
            ...
            <div className='grid grid-cols-2 gap-4 items-center justify-center pl-20 pt-6'>
                ...
                <Card className='flex flex-col bg-primary border border-solid worder-white items-center'>
                    ...
                    <CardContent>
                        <Button variant='outline' onClick={() => router.push('/adminclasses')}> 
                            View Classes
                        </Button>
                    </CardContent>
                </Card>
                ...
                <Card className='flex flex-col bg-primary border border-solid worder-white items-center'>
                    ...
                    <CardContent>
                        <Button variant='outline' onClick={() => router.push('/adminclients')}> 
                            View Clients
                        </Button>
                    </CardContent>
                </Card>
                ...
                <Card className='flex flex-col bg-primary border border-solid worder-white items-center'>
                    ...
                    <CardContent>
                        <Button variant='outline' onClick={() => router.push('/admincoaches')}> 
                            View Coaches
                        </Button>
                    </CardContent>
                </Card>
                ...
                <Card className='flex flex-col bg-primary border border-solid worder-white items-center'>
                    ...
                    <CardContent>
                        <Button variant='outline' onClick={() => router.push('/admincoachkey')}> 
                            Go Make Key
                        </Button>
                    </CardContent>
                </Card>
